...
uint16_t pot_dma_buffer[POT_ADC_BUFFER_SIZE];
...
int main(void)
{
  ...
  HAL_ADC_Start_DMA(&hadc2, (uint32_t*)pot_dma_buffer, POT_ADC_BUFFER_SIZE);

  HAL_ADC_Start_DMA(&hadc1, adc_buffer, AUDIO_BUFFER_SIZE);
